...
TRAIN_FILE=${TRAIN_FILE:-${ROOT}/data/attacker/train.parquet}
VAL_FILE=${VAL_FILE:-${ROOT}/data/attacker/val.parquet}
NGPUS=${NGPUS:-1}
...
"${PYTHON_BIN}" -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=route_selector_qwen3_1.7b_grpo \
